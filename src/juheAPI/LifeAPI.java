...
public class LifeAPI {
    public static final String API_URL = "http://apis.juhe.cn/simpleWeather/life"; // 请求第三方服务器地址
    ...
    public static void main(String[] args) {
        JSONObject jsonObject = queryLife("上海");
        System.out.println(jsonObject);
    }


    public static JSONObject queryLife(String city) {
