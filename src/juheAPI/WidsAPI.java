...
public class WidsAPI {
    public static final String API_URL = "http://apis.juhe.cn/simpleWeather/wids"; // 请求第三方服务器地址
    ...
    public static void main(String[] args) {
        JSONObject jsonObject = queryWids();
        System.out.println(jsonObject);
    }


    public static JSONObject queryWids() {
