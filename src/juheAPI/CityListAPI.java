...
public class CityListAPI {
    public static final String API_URL = "http://apis.juhe.cn/simpleWeather/cityList"; // 请求第三方服务器地址
    ...
    public static void main(String[] args) {
        JSONObject jsonObject = queryCityList();
        System.out.println(jsonObject);
    }


    public static JSONObject queryCityList() {
